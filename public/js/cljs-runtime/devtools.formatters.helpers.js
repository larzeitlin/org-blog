...
var G__9364 = devtools.prefs.pref(v);
v = G__9364;
continue;
} else {
return v;
...
}catch (e9314){var _e__8599__auto__ = e9314;
return false;
}})();
...
}catch (e9318){var _e__8599__auto__ = e9318;
return false;
}})();
...
}catch (e9321){var _e__8599__auto__ = e9321;
return false;
}}
}
});
...
var vec__9341 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9341,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9341,(1),null);
...
return cljs.core.some((function (p1__9346_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9346_SHARP_);
}),template);
});
