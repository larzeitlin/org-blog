...
var len__4864__auto___10941 = arguments.length;
var i__4865__auto___10942 = (0);
while(true){
if((i__4865__auto___10942 < len__4864__auto___10941)){
args__4870__auto__.push((arguments[i__4865__auto___10942]));

var G__10943 = (i__4865__auto___10942 + (1));
i__4865__auto___10942 = G__10943;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__10782_10944 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__10783_10945 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__10784_10946 = true;
var _STAR_print_fn_STAR__temp_val__10785_10947 = (function (x__4796__auto__){
return sb__4795__auto__.append(x__4796__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__10784_10946);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__10785_10947);

try{var _STAR_print_level_STAR__orig_val__10791_10948 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10792_10949 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10792_10949);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10791_10948);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__10783_10945);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__10782_10944);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq10774){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq10774));
}));
...
var new_formatters = current_formatters.filter((function (p1__10846_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__10846_SHARP_)));
}));
...
var G__10860_10966 = f;
var target__8595__auto___10967 = G__10860_10966;
if(cljs.core.truth_(target__8595__auto___10967)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10860_10966)].join(''),"\n","target__8595__auto__"].join('')));
}

(target__8595__auto___10967["toString"] = (function (){
...
var G__10863_10969 = "%c%s";
var G__10864_10970 = "color:transparent";
var G__10865_10971 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__10863_10969,G__10864_10970,G__10865_10971) : f.call(null,G__10863_10969,G__10864_10970,G__10865_10971));
...
var args__4870__auto__ = [];
var len__4864__auto___10977 = arguments.length;
var i__4865__auto___10979 = (0);
while(true){
if((i__4865__auto___10979 < len__4864__auto___10977)){
args__4870__auto__.push((arguments[i__4865__auto___10979]));

var G__10980 = (i__4865__auto___10979 + (1));
i__4865__auto___10979 = G__10980;
continue;
} else {
}
break;
...
var vec__10894 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10894,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10894,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__10982__delegate = function (add_fmt,add_args){
...
var G__10982 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__10983__i = 0, G__10983__a = new Array(arguments.length -  1);
while (G__10983__i < G__10983__a.length) {G__10983__a[G__10983__i] = arguments[G__10983__i + 1]; ++G__10983__i;}
  add_args = new cljs.core.IndexedSeq(G__10983__a,0,null);
} 
return G__10982__delegate.call(this,add_fmt,add_args);};
G__10982.cljs$lang$maxFixedArity = 1;
G__10982.cljs$lang$applyTo = (function (arglist__10984){
var add_fmt = cljs.core.first(arglist__10984);
var add_args = cljs.core.rest(arglist__10984);
return G__10982__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq10877){
var G__10878 = cljs.core.first(seq10877);
var seq10877__$1 = cljs.core.next(seq10877);
var G__10879 = cljs.core.first(seq10877__$1);
var seq10877__$2 = cljs.core.next(seq10877__$1);
var G__10880 = cljs.core.first(seq10877__$2);
var seq10877__$3 = cljs.core.next(seq10877__$2);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10878,G__10879,G__10880,seq10877__$3);
}));
...
var seq__10898 = cljs.core.seq(features);
var chunk__10899 = null;
var count__10900 = (0);
var i__10901 = (0);
while(true){
if((i__10901 < count__10900)){
var feature = chunk__10899.cljs$core$IIndexed$_nth$arity$2(null,i__10901);
...
var G__10985 = seq__10898;
var G__10986 = chunk__10899;
var G__10987 = count__10900;
var G__10988 = (i__10901 + (1));
seq__10898 = G__10985;
chunk__10899 = G__10986;
count__10900 = G__10987;
i__10901 = G__10988;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__10898);
if(temp__5753__auto__){
var seq__10898__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__10898__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__10898__$1);
var G__10990 = cljs.core.chunk_rest(seq__10898__$1);
var G__10991 = c__4679__auto__;
var G__10992 = cljs.core.count(c__4679__auto__);
var G__10993 = (0);
seq__10898 = G__10990;
chunk__10899 = G__10991;
count__10900 = G__10992;
i__10901 = G__10993;
continue;
} else {
var feature = cljs.core.first(seq__10898__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__10995 = cljs.core.next(seq__10898__$1);
var G__10996 = null;
var G__10997 = (0);
var G__10998 = (0);
seq__10898 = G__10995;
chunk__10899 = G__10996;
count__10900 = G__10997;
i__10901 = G__10998;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5751__auto__)){
var o10927 = temp__5751__auto__;
return (o10927["version"]);
} else {
return null;
}
})() == null);
