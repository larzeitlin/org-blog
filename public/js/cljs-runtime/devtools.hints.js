...
var map__9045 = top_item;
var map__9045__$1 = cljs.core.__destructure_map(map__9045);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9045__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9045__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9045__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e9040){var _e = e9040;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___9088 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___9088)){
var seen_errors_9089 = temp__5751__auto___9088;
if(cljs.core.truth_(seen_errors_9089.has(self))){
} else {
seen_errors_9089.add(self);

var temp__5753__auto___9090 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___9090)){
var sense_9091 = temp__5753__auto___9090;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_9091)].join(''));
} else {
}
}
} else {
