...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32465 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32465(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32467 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32467(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32470 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32470(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32471 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32471(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32472 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32472(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32476 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32476(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32459,callback){
var map__32460 = p__32459;
var map__32460__$1 = cljs.core.__destructure_map(map__32460);
var input = map__32460__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32460__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32460__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
