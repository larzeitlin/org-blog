...
var and__4251__auto____$1 = (function (){var fexpr__13246 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["",null,"_self",null], null), null);
return (fexpr__13246.cljs$core$IFn$_invoke$arity$1 ? fexpr__13246.cljs$core$IFn$_invoke$arity$1(link_target) : fexpr__13246.call(null,link_target));
})();
if(cljs.core.truth_(and__4251__auto____$1)){
 ...
 */
accountant.core.configure_navigation_BANG_ = (function accountant$core$configure_navigation_BANG_(p__13250){
var map__13251 = p__13250;
var map__13251__$1 = cljs.core.__destructure_map(map__13251);
var nav_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13251__$1,new cljs.core.Keyword(null,"nav-handler","nav-handler",2039495484));
var path_exists_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13251__$1,new cljs.core.Keyword(null,"path-exists?","path-exists?",1473384514));
var reload_same_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13251__$1,new cljs.core.Keyword(null,"reload-same-path?","reload-same-path?",1981904231));
...
var seq__13252 = cljs.core.seq(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [accountant.core.document_click_handler_listener_key,accountant.core.navigate_listener_key], null));
var chunk__13253 = null;
var count__13254 = (0);
var i__13255 = (0);
while(true){
if((i__13255 < count__13254)){
var key = chunk__13253.cljs$core$IIndexed$_nth$arity$2(null,i__13255);
...
var G__13275 = seq__13252;
var G__13276 = chunk__13253;
var G__13277 = count__13254;
var G__13278 = (i__13255 + (1));
seq__13252 = G__13275;
chunk__13253 = G__13276;
count__13254 = G__13277;
i__13255 = G__13278;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__13252);
if(temp__5753__auto__){
var seq__13252__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__13252__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__13252__$1);
var G__13279 = cljs.core.chunk_rest(seq__13252__$1);
var G__13280 = c__4679__auto__;
var G__13281 = cljs.core.count(c__4679__auto__);
var G__13282 = (0);
seq__13252 = G__13279;
chunk__13253 = G__13280;
count__13254 = G__13281;
i__13255 = G__13282;
continue;
} else {
var key = cljs.core.first(seq__13252__$1);
if(cljs.core.truth_(key)){
goog.events.unlistenByKey(key);
} else {
}
...
var G__13283 = cljs.core.next(seq__13252__$1);
var G__13284 = null;
var G__13285 = (0);
var G__13286 = (0);
seq__13252 = G__13283;
chunk__13253 = G__13284;
count__13254 = G__13285;
i__13255 = G__13286;
continue;
}
} else {
...
var params = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13259_SHARP_){
return cljs.core.name(p1__13259_SHARP_);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("&",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13260_SHARP_){
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("=",p1__13260_SHARP_);
}),pairs));
});
/**
...
if(cljs.core.truth_(accountant.core.nav_handler)){
var G__13268 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(query),cljs.core.str.cljs$core$IFn$_invoke$arity$1(hash)].join('');
return (accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1 ? accountant.core.nav_handler.cljs$core$IFn$_invoke$arity$1(G__13268) : accountant.core.nav_handler.call(null,G__13268));
} else {
