...
var G__30499 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__30499;
continue;
} else {
return ch;
...
var vec__30489 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30489,(0),null);
return (match === s);
});
...
var len__4864__auto___30504 = arguments.length;
var i__4865__auto___30505 = (0);
while(true){
if((i__4865__auto___30505 < len__4864__auto___30504)){
args__4870__auto__.push((arguments[i__4865__auto___30505]));

var G__30506 = (i__4865__auto___30505 + (1));
i__4865__auto___30505 = G__30506;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq30495){
...
return (function() { 
var G__30509__delegate = function (rdr,_){
...
var G__30509 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__30510__i = 0, G__30510__a = new Array(arguments.length -  1);
while (G__30510__i < G__30510__a.length) {G__30510__a[G__30510__i] = arguments[G__30510__i + 1]; ++G__30510__i;}
  _ = new cljs.core.IndexedSeq(G__30510__a,0,null);
} 
return G__30509__delegate.call(this,rdr,_);};
G__30509.cljs$lang$maxFixedArity = 1;
G__30509.cljs$lang$applyTo = (function (arglist__30511){
var rdr = cljs.core.first(arglist__30511);
var _ = cljs.core.rest(arglist__30511);
return G__30509__delegate(rdr,_);
});
