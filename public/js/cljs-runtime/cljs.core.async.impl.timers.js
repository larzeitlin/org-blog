...
var i_32366 = (self__.level + (1));
while(true){
if((i_32366 <= (new_level + (1)))){
(update[i_32366] = self__.header);

var G__32372 = (i_32366 + (1));
i_32366 = G__32372;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_32373 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32373[i]));
} else {
x__$2.forward.push((((i < links_32373.length))?(links_32373[i]):null));
}

if((i < links_32373.length)){
(links_32373[i] = x__$2);
} else {
links_32373.push(x__$2);
}
...
var i_32375 = (0);
while(true){
if((i_32375 <= self__.level)){
var links_32377 = (update[i_32375]).forward;
if((x__$1 === (((i_32375 < links_32377.length))?(links_32377[i_32375]):null))){
(links_32377[i_32375] = (x__$1.forward[i_32375]));

var G__32379 = (i_32375 + (1));
i_32375 = G__32379;
continue;
} else {
var G__32381 = (i_32375 + (1));
i_32375 = G__32381;
continue;
}
} else {
