...
var G__12840 = o;
reagent.impl.template.goog$module$goog$object.set(G__12840,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__12924__i = 0, G__12924__a = new Array(arguments.length -  0);
while (G__12924__i < G__12924__a.length) {G__12924__a[G__12924__i] = arguments[G__12924__i + 0]; ++G__12924__i;}
  args = new cljs.core.IndexedSeq(G__12924__a,0,null);
} 
return G__12923__delegate.call(this,args);};
G__12923.cljs$lang$maxFixedArity = 0;
G__12923.cljs$lang$applyTo = (function (arglist__12925){
...
var G__12846 = o;
reagent.impl.template.goog$module$goog$object.set(G__12846,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__12932__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__12934__i < G__12934__a.length) {G__12934__a[G__12934__i] = arguments[G__12934__i + 0]; ++G__12934__i;}
  args = new cljs.core.IndexedSeq(G__12934__a,0,null);
} 
...
var G__12847 = props;
var G__12847__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12847,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12847);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12847__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__12855 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12855,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__12855;
}
})(),id_class);
...
var G__12861 = (cljs.core.count(argv) - first_child);
switch (G__12861) {
case (0):
...
var vec__12870 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12870,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12870,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12870,(2),null);
...
var temp__5757__auto___12946 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___12946 == null)){
} else {
var key_12947 = temp__5757__auto___12946;
(jsprops.key = key_12947);
}
...
var temp__5757__auto___12951 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___12951 == null)){
} else {
var key_12953 = temp__5757__auto___12951;
...
var temp__5757__auto___12958 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___12958 == null)){
} else {
var key_12959 = temp__5757__auto___12958;
(jsprops.key = key_12959);
}
...
var temp__5757__auto___12973 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___12973 == null)){
} else {
var key_12974 = temp__5757__auto___12973;
(jsprops.key = key_12974);
}
...
var temp__5757__auto___12978 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___12978 == null)){
} else {
var key_12979 = temp__5757__auto___12978;
(jsprops.key = key_12979);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12887_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__12887_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12888 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12888,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12888,(1),null);
...
break;
default:
var G__12993 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__12994 = compiler;
v = G__12993;
compiler = G__12994;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template12905 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template12905 = (function (opts,id,fn_to_element,parse_fn,meta12906){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12905.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12907,meta12906__$1){
var self__ = this;
var _12907__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12905(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta12906__$1));
}));

(reagent.impl.template.t_reagent$impl$template12905.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12907){
var self__ = this;
var _12907__$1 = this;
return self__.meta12906;
}));

(reagent.impl.template.t_reagent$impl$template12905.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12905.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12905.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template12905.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12905.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12905.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta12906","meta12906",-1963612624,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12905.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12905.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12905");

(reagent.impl.template.t_reagent$impl$template12905.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template12905");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12905.
 */
reagent.impl.template.__GT_t_reagent$impl$template12905 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template12905(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta12906){
return (new reagent.impl.template.t_reagent$impl$template12905(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta12906));
});

}

return (new reagent.impl.template.t_reagent$impl$template12905(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
