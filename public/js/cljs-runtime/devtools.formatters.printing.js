...
var len__4864__auto___9426 = arguments.length;
var i__4865__auto___9427 = (0);
while(true){
if((i__4865__auto___9427 < len__4864__auto___9426)){
args__4870__auto__.push((arguments[i__4865__auto___9427]));

var G__9428 = (i__4865__auto___9427 + (1));
i__4865__auto___9427 = G__9428;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9374){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9375,G__9376,seq9374__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9395_SHARP_){
return (!((cljs.core.meta(p1__9395_SHARP_) == null)));
})))){
...
var map__9412 = opts;
var map__9412__$1 = cljs.core.__destructure_map(map__9412);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9412__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9413){var _e__8599__auto__ = e9413;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e9416){var _e__8599__auto__ = e9416;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9419 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9420 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9420);

try{var map__9421 = opts;
var map__9421__$1 = cljs.core.__destructure_map(map__9421);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9421__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9419);
}});
...
var temp__5751__auto___9436 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___9436)){
var managed_print_level_9437 = temp__5751__auto___9436;
var _STAR_print_level_STAR__orig_val__9423_9439 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9424_9440 = managed_print_level_9437;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9424_9440);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__9422_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__9422_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9423_9439);
}} else {
job_fn();
}
