...
var o9056 = temp__5751__auto__;
var temp__5751__auto____$1 = (o9056["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o9057 = temp__5751__auto____$1;
return (o9057["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8554__auto__ = f;
return (o__8554__auto__["toString"]).call(o__8554__auto__);
} else {
return "";
}
}catch (e9064){var _ = e9064;
return "";
}});
...
try{var o__8554__auto___9301 = t;
(o__8554__auto___9301["cljs$lang$ctorPrWriter"]).call(o__8554__auto___9301,t,writer);
}catch (e9076){var __9302 = e9076;
}
...
var char_code = (function (){var o__8554__auto__ = (new String(char$));
return (o__8554__auto__["charCodeAt"]).call(o__8554__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8554__auto__ = String;
return (o__8554__auto__["fromCharCode"]).call(o__8554__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9092 = num_code;
switch (G__9092) {
case (1):
return (185);
...
var o__8554__auto__ = String;
return (o__8554__auto__["fromCharCode"]).call(o__8554__auto__,superscript_code);
});
/**
...
}catch (e9100){var _e__8599__auto__ = e9100;
return false;
}})())){
...
var vec__9102 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9102,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9124){
var vec__9125 = p__9124;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9125,(0),null);
...
var G__9330 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__9331 = cljs.core.butlast(remaining_tokens);
name_tokens = G__9330;
remaining_tokens = G__9331;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9121){
var G__9122 = cljs.core.first(seq9121);
var seq9121__$1 = cljs.core.next(seq9121);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9122,seq9121__$1);
}));
...
var vec__9137 = cljs.core.split_with((function (p1__9136_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__9136_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9137,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9137,(1),null);
...
var vec__9145 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9145,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9145,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__9335 = cljs.core.rest(remaining_tokens);
var G__9336 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__9335;
name_tokens = G__9336;
continue;
} else {
...
var vec__9158 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9158,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9158,(1),null);
var vec__9161 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9161,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9161,(1),null);
var vec__9164 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9164,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9164,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9164,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9164,(3),null);
...
var vec__9174 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9174,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9174,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9174,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9174,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9174,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9174,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__9184 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9184,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9184,(1),null);
var vec__9187 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9187,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9187,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__9198 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__9198) : devtools.munging.parse_fn_info_deep.call(null,G__9198));
})()));
}
} else {
return fn_info;
...
var G__9350 = (arity + (1));
var G__9351 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9206){
var vec__9207 = p__9206;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9207,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9207,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9222_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__9222_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9223_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__9223_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___9360 = arguments.length;
var i__4865__auto___9361 = (0);
while(true){
if((i__4865__auto___9361 < len__4864__auto___9360)){
args__4870__auto__.push((arguments[i__4865__auto___9361]));

var G__9362 = (i__4865__auto___9361 + (1));
i__4865__auto___9361 = G__9362;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9231){
var vec__9232 = p__9231;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9232,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9228){
var G__9229 = cljs.core.first(seq9228);
var seq9228__$1 = cljs.core.next(seq9228);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9229,seq9228__$1);
}));
...
var map__9243__$1 = cljs.core.__destructure_map(map__9243);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9243__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9243__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9243__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9243__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9244 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9244,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9244,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9244,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9244,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9244,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9244,(5),null);
...
var o__8554__auto__ = f;
return (o__8554__auto__["getBasis"]).call(o__8554__auto__);
});
/**
...
}catch (e9248){var _e__8599__auto__ = e9248;
...
var G__9380 = (obj[cljs.core.first(path)]);
var G__9381 = cljs.core.rest(path);
obj = G__9380;
path = G__9381;
continue;
} else {
...
var _STAR_ = (function (accum,p__9260){
var vec__9261 = p__9260;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9261,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9261,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9267){
...
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9268,(2),null);
...
var post_process = (function (p__9285){
var vec__9286 = p__9285;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9286,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9286,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9279_SHARP_){
return (obj[cljs.core.first(p1__9279_SHARP_)]);
}),sorted_matches);
